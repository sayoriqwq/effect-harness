...
| --- | --- | --- | --- | --- | --- |
| Setup target repo | `harness/target-agent-contract.md` | `repos/effect.subtree.json`, `repos/effect/LLMS.md` | `effect-harness init`, `harness/runtime/codex/` | target `pnpm effect:verify`, `pnpm verify` | target `.codex/effect-feedback/` |
